...
import 'package:zchat/views/data_classes/leading_widget_data.dart';
...
import '../widgets/chats_page_widgets/chats_page_appbar_pin_action_widget.dart';
import '../widgets/miscellaneous/appbar_widget.dart';
import '../widgets/miscellaneous/scaled_text_widget.dart';
import 'app_text_styles.dart';

List<Widget> pagesAppBars(BuildContext context) => [
    ...
    builder: (context, selectedChats, child) {
      ...
      return AppBarWidget(
        ...
        leading: LeadingWidgetData(
          ...
          showLeading: ChatSelectionController.isSelectionMode,
        ),
        actions: [
